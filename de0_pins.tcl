...
#   set_location_assignment PIN_B12 -to CLOCK_50_2 ;# Global Clock 9
   ...
   set_location_assignment PIN_H2 -to KEY0 ;# KEY0/BUTTON0 (right button covered)
   ...
   set_location_assignment PIN_J6 -to resetN1 ;# SW[0]
 #  set_location_assignment PIN_H5 -to S2 ;# SW[1]
#   set_location_assignment PIN_H6 -to S3 ;# SW[2]
